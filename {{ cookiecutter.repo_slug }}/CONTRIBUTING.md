...
- All code should be typed when possible.
  ...
  - Also import common types like `List` from `{{ cookiecutter.module_slug }}/typing.py` instead of the built-in `typing` module.
...
[Issue]: https://github.com/MrThearMan/{{ cookiecutter.repo_slug }}/issues/new/choose
...
[new release]: https://github.com/MrThearMan/{{ cookiecutter.repo_slug }}/blob/main/CONTRIBUTING.md#creating-a-new-release
